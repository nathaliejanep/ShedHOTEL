        ...
        <div className='rooms'>
            ...
            <div className='container'>
                <section className='container__section'>
                    <h1>Our Rooms</h1>
                    <p>
                        With categories that cater to everyone's demands, all our newly renovated rooms feature ultra-comfy beds, desks for
                        your remote work, smart TVs, views over the mountain peaks, eccentric books and curated artworks.
                    </p>
                </section>
                <div className='rooms__card-wrapper'>
                    <div className='rooms__card'>
                        ...
                        <div className='rooms__card-text'>
                            <h3>Roomie</h3>
                            <p className='rooms__card-text__capacity'>1 king size beds + 1 single bed | approx 30m² up to 3 adults</p>
                            <p>
                                With lots of space to take in the air of the Alps, Roomie is the go-to room for those wanting that extra
                                space to stretch out the legs after a day on the mountain. Enjoy your après on the big balcony, your book on
                                the sofa and your sleep in the comfy king size bed.
                            </p>
                        </div>
                        <a
                    ...
                    <div className='rooms__card'>
                        ...
                        <div className='rooms__card-text'>
                            <h3>Biggie</h3>
                            <p className='rooms__card-text__capacity'>2 king size beds | approx 45m² up to 4 adults + 3 children</p>
                            <p>
                                With extra space over two connected bedrooms, featuring a king size bed in each, Biggie is perfect for
                                longer stays with friends or family. After a full day of exploring the mountains, this room, with its big
                                sunny balcony, brings you back together.
                            </p>
                        </div>
                        <a
                            href='https://sky-eu1.clock-software.com/spa/pms-wbe/#/hotel/12633'
                    ...
                    <div className='rooms__card'>
                        ...
                        <div className='rooms__card-text'>
                            ...
                            <p className='rooms__card-text__capacity'>
                                1 king size bed + 1 sofa bed | approx 45m² up to 2 adults + 2 children
                            </p>
                            <p>
                                Situated on the top floor with a sunny balcony overlooking the Grand Combin, our Big Buddie Suite is the
                                ideal nest for your Alp holiday. Spacious, comfortable and contemporary, this suite welcomes you with
                                luxurious duvets, an area for relaxation and a desk for your work break.
                            </p>
                        </div>
                        <a
                            href='https://sky-eu1.clock-software.com/spa/pms-wbe/#/hotel/12633'
                    ...
                    <div className='rooms__card'>
                        ...
                        <div className='rooms__card-text'>
                            <h3>Buddie</h3>
                            <p className='rooms__card-text__capacity'>1 King size bed | Approx 20m² up to 2 adults + 1 children.</p>
                            <p>
                                Comfortable and contemporary, Buddie is the perfect choice for those traveling with a partner or a friend.
                                Oriented north, the room offers a large balcony overlooking Alpine peaks, a king size bed, a desk and all
                    ...
                    <div className='rooms__card'>
                        ...
                        <div className='rooms__card-text'>
                            <h3>Loonie</h3>
                            <p className='rooms__card-text__capacity'>1 large single bed | approx 15m² up to 1 adult</p>
                            <p>
                                Loonie is compact yet comfy - the perfect room for the mountaineer. Expect views of your next mission's
                                peaks, a desk for your remote work and a comfortable, large single bed for a good night's sleep.
                            </p>
                        </div>
                        <a
                            href='https://sky-eu1.clock-software.com/spa/pms-wbe/#/hotel/12633'
